...
plt.plot(time, pos, label = "Position (radians)")
plt.plot(time, vel, label = "Velocity(radians/s)")
plt.plot(time, acc, label = "Acceleration (radians/seconds squared)")
plt.title("Pendulum Simulation - 10 inch Trial")
plt.xlabel("Time")
...
plt.plot(time, vel, label = "Velocity(radians/s)")
plt.plot(time, acc, label = "Acceleration (radians/seconds squared)")
plt.title("Pendulum Simulation - 12 inch Trial")
plt.xlabel("Time")
plt.legend(loc = "lower center")
plt.show()
period(pos)

os, vel, acc = run_simulation(0.356, np.pi/3)  
plt.plot(time, pos, label = "Position (radians)")
plt.plot(time, vel, label = "Velocity(radians/s)")
plt.plot(time, acc, label = "Acceleration (radians/seconds squared)")
plt.title("Pendulum Simulation - 14 inch Trial")
plt.xlabel("Time")
plt.legend(loc = "lower center")
plt.show()
period(pos)

os, vel, acc = run_simulation(0.406, np.pi/3)  
plt.plot(time, pos, label = "Position (radians)")
plt.plot(time, vel, label = "Velocity(radians/s)")
plt.plot(time, acc, label = "Acceleration (radians/seconds squared)")
plt.title("Pendulum Simulation - 16 inch Trial")
plt.xlabel("Time")
plt.legend(loc = "lower center")
plt.show()
period(pos)

os, vel, acc = run_simulation(0.457, np.pi/3)  
plt.plot(time, pos, label = "Position (radians)")
plt.plot(time, vel, label = "Velocity(radians/s)")
plt.plot(time, acc, label = "Acceleration (radians/seconds squared)")
plt.title("Pendulum Simulation - 18 inch Trial")
plt.xlabel("Time")
plt.legend(loc = "lower center")
plt.show()
period(pos)
